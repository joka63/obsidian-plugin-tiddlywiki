...
type TiddlyToMarkdownTestData = { tiddlerText: string, expectedMarkdown: string };

describe("convert ", () => {
    it.each<TiddlyToMarkdownTestData>([
        {
        ...
        ])("should convert a TiddlyWiki tiddler to Markdown", ({tiddlerText, expectedMarkdown}) => {
